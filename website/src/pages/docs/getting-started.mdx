...
If you don't know any of two, it is easier to start with [styled-components](https://styled-components.com).
...
> Even if it is not strictly required, it is strongly recommended to add `Normalize` in your application, see [guide](/docs/normalize/).
